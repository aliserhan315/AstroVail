...
export default function IndexGate() {
  ...
  useEffect(() => {
    ...
    (async () => {
      try {
        const [seen, t1, t2, t3] = await Promise.all([
          AsyncStorage.getItem("av_seen_onboarding"),
          AsyncStorage.getItem("av_token"),
          AsyncStorage.getItem("av_access_token"),
          AsyncStorage.getItem("av_access"),
        ]);
    ...
    <View style={{ flex: 1, backgroundColor: "#000" }}>
      ...
      >
        ...
        >
          <Image
            source={LOGO}
            accessibilityLabel="AstroVail logo"
